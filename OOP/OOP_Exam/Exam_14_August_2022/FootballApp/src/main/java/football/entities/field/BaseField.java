...
public abstract class BaseField implements Field {
    ...
    public int sumEnergy() {
        return supplements.stream().map(Supplement::getEnergy).collect(Collectors.summingInt(Integer::intValue));
    }
    ...
    public String getInfo() {
        ...
        return String.format("%s (%s):%n" +
                "Player: %s%n" +
                "Supplement: %s%n" +
                "Energy: %s",name,this.getClass().getSimpleName(),playersOutput,supplements.size(),this.sumEnergy());
    }
