...
// Initialize entities
        ...
        Student six = new Student("Koko", "kokov", "C#");
        Student seven = new Student("Dimitur", "Dimitrov", "Java");
        Student eight = new Student("Alokard", "Vladimirov", "Java");
...
// Register Student
        ...
        softUni.insert(studentFive);
        softUni.insert(six);
        softUni.insert(seven);
        softUni.insert(eight);// not added Good
...
//Student: Alex Raykova, Best Course = Python
        ...
        System.out.println(softUni.remove(seven));
    }
}
